...
urlpatterns = [
    ...
    path("talks/<int:talk_id>/questions/new/", QuestionCreateView.as_view(), name="question_create"),
    ...
    path("questions/<int:question_id>/mark-answered/", mark_question_answered, name="question_mark_answered"),
