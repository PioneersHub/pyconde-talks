        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Name of the person asking the question (optional)",
                        max_length=100,
                    ),
                ),
                (
                    ...
                    models.EmailField(
                        blank=True,
                        help_text="Email of the person asking the question (optional)",
                        max_length=254,
                    ),
                ),
                (
                ...
                (
                    "is_anonymous",
                    models.BooleanField(
                        default=False, help_text="Whether to display the author's name"
                    ),
                ),
                (
                    "created_at",
                    models.DateTimeField(
                        default=django.utils.timezone.now, help_text="When this question was asked"
                    ),
                ),
                (
                    "updated_at",
                    models.DateTimeField(
                        auto_now=True, help_text="When this question was last modified"
                    ),
                ),
                (
                    "talk",
                    models.ForeignKey(
                        help_text="Talk this question is about",
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="User who asked the question (if logged in)",
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_at",
                    models.DateTimeField(
                        default=django.utils.timezone.now, help_text="When this vote was created"
                    ),
                ),
                (
                    "question",
                    models.ForeignKey(
                        help_text="Question being voted on",
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="votes",
                        to="talks.question",
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Whether this is an official answer from a speaker or organizer",
                    ),
                ),
                (
                    "created_at",
                    models.DateTimeField(
                        default=django.utils.timezone.now, help_text="When this answer was created"
                    ),
                ),
                (
                    "updated_at",
                    models.DateTimeField(
                        auto_now=True, help_text="When this answer was last modified"
                    ),
                ),
                (
                    "question",
